...
class Settings(BaseSettings):
    ...
    deep_reasoning_enabled: bool = Field(default=True, alias="KEMY_DEEP_REASONING_ENABLED")
    reasoning_review_passes: int = Field(default=2, alias="KEMY_REASONING_REVIEW_PASSES")
    adaptive_reasoning_budget: bool = Field(default=True, alias="KEMY_ADAPTIVE_REASONING_BUDGET")
    code_validation_enabled: bool = Field(default=True, alias="KEMY_CODE_VALIDATION_ENABLED")
    code_autofix_attempts: int = Field(default=2, alias="KEMY_CODE_AUTOFIX_ATTEMPTS")
    workspace_root: str = Field(default=".", alias="KEMY_WORKSPACE_ROOT")
    browser_qa_enabled: bool = Field(default=True, alias="KEMY_BROWSER_QA_ENABLED")
    strong_sandbox_enabled: bool = Field(default=True, alias="KEMY_STRONG_SANDBOX_ENABLED")
    worktree_editor_enabled: bool = Field(default=False, alias="KEMY_WORKTREE_EDITOR_ENABLED")
