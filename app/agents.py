...
def build_prompt_refiner_prompt(
    ...
    return (
        ...
        "Nao escreva codigo final nem XML de artifact aqui.\n"
        "Se o plano indicar documento/slides, escreva requisitos de conteudo e design, nunca requisitos de implementacao interna do docx.\n"
...
def build_local_prompt_brief(
    ...
    site_quality = (
        ...
        "- COMPLEXIDADE MINIMA: minimo 300 linhas de HTML ou 200 linhas de JSX, com logica real (filtros, buscas, states, interacoes, animacoes, formularios funcionando).\n"
        "- REGRA CRITICA: Construir EXATAMENTE o que o usuario pediu. Se pediu uma loja de roupas, entregue loja de roupas. Se pediu um dashboard de financas, entregue isso.\n"
        "- NUNCA gerar um site de barbearia, portfolio, restaurante generico quando nao foi pedido isso.\n"
    ...
    daily_quality = (
        "- Se for modo planejamento, atuar como assistente operacional: priorizar clareza, checklist, passos e exemplos praticos.\n"
        "- Nao gerar codigo nem stack tecnica sem pedido explicito.\n"
