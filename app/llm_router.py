    ...
    def _system_prompt(self, provider: str, mode: str) -> str:
        ...
        if mode == "documento":
            return (
                ...
                "abra com um slide-capa forte; organize a historia em 6 a 10 slides; use titulos de ate 6 palavras sempre que possivel; use no maximo 3 a 4 bullets por slide; cada bullet deve ser especifico e acionavel; "
                ...
                "escreva bullets com lideres fortes como `**Ponto**` seguido de uma frase curta; para metricas, prefira linhas curtas no formato `**Metrica** - valor ou insight`; para comparacoes, prefira tabela curta; para processos, prefira 3 a 5 etapas nominais; "
                ...
                "escreva cada slide como conteudo pronto para um renderizador PPTX profissional: hierarquia limpa, pouca densidade por pagina, frases que encaixem bem em capa, agenda, cards, tabela, timeline e fechamento; "
                "na capa, use um titulo memoravel, um subtitulo curto e no maximo um apoio; na agenda, use itens curtissimos de duas a quatro palavras; em metricas, use no maximo quatro sinais fortes; em comparacoes, simplifique a tabela; em timelines, nomeie etapas com objetividade; "
                "priorize linguagem de consultoria premium: clara, elegante, especifica e sem didatismo excessivo; prefira sintese com impacto em vez de explicacao longa; evite bullets longos que ocupem varias linhas; "
                "quando um slide puder ser melhor como insight, transforme-o em uma afirmacao forte com apoio curto; quando puder ser melhor como comparacao, use pares limpos; quando puder ser melhor como processo, use nomes curtos de etapa; "
                "nao repita o titulo do slide como bullet ou subtitulo; nao use frases genericas como `visual executivo`; nao use bullets com mais de 14 palavras; "
