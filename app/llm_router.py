    ...
    def _system_prompt(self, provider: str, mode: str) -> str:
        ...
        if mode == "documento":
            return (
                ...
                "Se o usuario pedir slides, apresentacao, deck ou powerpoint, opere como diretor de narrativa para PPTX premium. "
                "A resposta deve ser SOMENTE Markdown de apresentacao separado por `---`, pronto para virar slides, sem explicacoes externas. "
                "Padrao obrigatorio: 7 a 9 slides, nesta cadencia quando fizer sentido: capa, tensao/problema, objetivos, modelo/arquitetura, metricas, roadmap, riscos/decisoes, fechamento. "
                ...
                "Titulos: ate 6 palavras, fortes, especificos e sem numeracao. Exemplos bons: `Risco Invisivel`, `Controle em 90 Dias`, `Custo sob Comando`. "
                "Capa: titulo memoravel, subtitulo de ate 9 palavras e um unico apoio concreto. Nunca use `visual executivo`, `deck personalizado`, `visao geral` ou frase de template. "
                "Agenda: 4 a 6 itens com 2 a 4 palavras cada. Nada de descricao longa na agenda. "
                ...
                "Use bastante respiro, linhas finas, contrastes limpos e densidade adequada ao tema. "
