    ...
    def _system_prompt(self, provider: str, mode: str) -> str:
        ...
        if mode == "documento":
            return (
                ...
                "quando devolver HTML de apresentacao, inclua CSS de impressao com `@media print`, `@page { size: 1920px 1080px; margin: 0; }`, `print-color-adjust: exact !important` e wrappers que evitem quebra de slide; "
                "na renderizacao de slide, use geometria fixa Full HD: `w-[1920px] h-[1080px]`, sem `vh`, `vw`, `h-screen`, `w-screen` ou classes fluidas equivalentes; "
