    ...
    def _system_prompt(self, provider: str, mode: str) -> str:
        ...
        if mode == "documento":
            return (
                ...
                "na capa, evite excesso de texto; na agenda, use itens curtos e claros; em metricas, use no maximo quatro sinais fortes; em comparacoes, simplifique a tabela; em timelines, nomeie etapas com objetividade; "
